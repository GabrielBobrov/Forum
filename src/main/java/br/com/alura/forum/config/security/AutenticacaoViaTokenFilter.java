...
public class AutenticacaoViaTokenFilter extends OncePerRequestFilter {
	...
	public AutenticacaoViaTokenFilter(TokenService tokenService, UsuarioRepository usuarioReposiroty) {
	...
	private void autenticarCliente(String token) {
		...
		Usuario usuario = usuarioReposiroty.findById(idUsuario).get();
